# This Makefile is for the Crypt::X509::CRL extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Crypt/X509/CRL.pm]
#     AUTHOR => [q[Duncan Segrest]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => { ExtUtils::MakeMaker=>q[0] }
#     LICENSE => q[artistic_2]
#     META_MERGE => { meta-spec=>{ version=>q[2] }, resources=>{ bugtracker=>{ web=>q[https://github.com/gigageeks/Crypt-X509-CRL/issues] }, homepage=>q[https://github.com/gigageeks/], repository=>{ type=>q[git], url=>q[https://github.com/gigageeks/Crypt-X509-CRL.git], web=>q[https://github.com/gigageeks/Crypt-X509-CRL] } } }
#     MIN_PERL_VERSION => q[5.006]
#     NAME => q[Crypt::X509::CRL]
#     PREREQ_PM => { Convert::ASN1=>q[0.19], Test::More=>q[0] }
#     TEST_REQUIRES => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/Crypt/X509/CRL.pm]
#     clean => { FILES=>q[Crypt-X509-CRL-*] }
...
PERL_LIB = D:\Strawberry\perl\lib
PERL_ARCHLIB = D:\Strawberry\perl\lib
PERL_ARCHLIBDEP = D:\Strawberry\perl\lib
LIBPERL_A = libperl.a
...
PERL_INCDEP = D:\Strawberry\perl\lib\CORE
...
MAKE = gmake
FULLEXT = Crypt\X509\CRL
BASEEXT = CRL
PARENT_NAME = Crypt::X509
DLBASE = $(BASEEXT)
...
INST_LIBDIR      = $(INST_LIB)\Crypt\X509
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\Crypt\X509
...
TO_INST_PM = lib/Crypt/X509/CRL.pm
...
DISTNAME = Crypt-X509-CRL
DISTVNAME = Crypt-X509-CRL-0.4
...
CRL.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Crypt::X509::CRL\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "abstract: 'Parses an X.509 certificate revocation list'" >> META_new.yml
	$(NOECHO) $(ECHO) author: >> META_new.yml
	$(NOECHO) $(ECHO) "  - 'Duncan Segrest'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "name: Crypt-X509-CRL" >> META_new.yml
	$(NOECHO) $(ECHO) no_index: >> META_new.yml
	$(NOECHO) $(ECHO) "  directory:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - t" >> META_new.yml
	$(NOECHO) $(ECHO) "    - inc" >> META_new.yml
	$(NOECHO) $(ECHO) requires: >> META_new.yml
	$(NOECHO) $(ECHO) "  Convert::ASN1: '0.19'" >> META_new.yml
	$(NOECHO) $(ECHO) "  perl: '5.006'" >> META_new.yml
	$(NOECHO) $(ECHO) resources: >> META_new.yml
	$(NOECHO) $(ECHO) "  bugtracker: https://github.com/gigageeks/Crypt-X509-CRL/issues" >> META_new.yml
	$(NOECHO) $(ECHO) "  homepage: https://github.com/gigageeks/" >> META_new.yml
	$(NOECHO) $(ECHO) "  repository: https://github.com/gigageeks/Crypt-X509-CRL.git" >> META_new.yml
	$(NOECHO) $(ECHO) "version: '0.4'" >> META_new.yml
	$(NOECHO) $(ECHO) "x_serialization_backend: 'CPAN::Meta::YAML version 0.018'" >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) { > META_new.json
	$(NOECHO) $(ECHO) "   \"abstract\" : \"Parses an X.509 certificate revocation list\"," >> META_new.json
	$(NOECHO) $(ECHO) "   \"author\" : [" >> META_new.json
	$(NOECHO) $(ECHO) "      \"Duncan Segrest\"" >> META_new.json
	$(NOECHO) $(ECHO) "   ]," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"Crypt-X509-CRL\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "         \"requires\" : {" >> META_new.json
	$(NOECHO) $(ECHO) "            \"Convert::ASN1\" : \"0.19\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "         \"web\" : \"https://github.com/gigageeks/Crypt-X509-CRL/issues\"" >> META_new.json
	$(NOECHO) $(ECHO) "      }," >> META_new.json
	$(NOECHO) $(ECHO) "      \"homepage\" : \"https://github.com/gigageeks/\"," >> META_new.json
	$(NOECHO) $(ECHO) "      \"repository\" : {" >> META_new.json
	$(NOECHO) $(ECHO) "         \"type\" : \"git\"," >> META_new.json
	$(NOECHO) $(ECHO) "         \"url\" : \"https://github.com/gigageeks/Crypt-X509-CRL.git\"," >> META_new.json
	$(NOECHO) $(ECHO) "         \"web\" : \"https://github.com/gigageeks/Crypt-X509-CRL\"" >> META_new.json
	$(NOECHO) $(ECHO) "      }" >> META_new.json
	$(NOECHO) $(ECHO) "   }," >> META_new.json
...
MAP_TARGET    = perl
FULLPERL      = "D:\Strawberry\perl\bin\perl.exe"
MAP_PERLINC   = "-Iblib\arch" "-Iblib\lib" "-ID:\Strawberry\perl\lib" "-ID:\Strawberry\perl\lib"
...
ppd :
	$(NOECHO) $(ECHO) "<SOFTPKG NAME=\"Crypt-X509-CRL\" VERSION=\"0.4\">" > Crypt-X509-CRL.ppd
	$(NOECHO) $(ECHO) "    <ABSTRACT>Parses an X.509 certificate revocation list</ABSTRACT>" >> Crypt-X509-CRL.ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>Duncan Segrest</AUTHOR>" >> Crypt-X509-CRL.ppd
	$(NOECHO) $(ECHO) "    <IMPLEMENTATION>" >> Crypt-X509-CRL.ppd
	$(NOECHO) $(ECHO) "        <PERLCORE VERSION=\"5,006,0,0\" />" >> Crypt-X509-CRL.ppd
	$(NOECHO) $(ECHO) "        <REQUIRE NAME=\"Convert::ASN1\" VERSION=\"0.19\" />" >> Crypt-X509-CRL.ppd
	$(NOECHO) $(ECHO) "        <ARCHITECTURE NAME=\"MSWin32-x64-multi-thread-5.32\" />" >> Crypt-X509-CRL.ppd
	$(NOECHO) $(ECHO) "        <CODEBASE HREF=\"\" />" >> Crypt-X509-CRL.ppd
	$(NOECHO) $(ECHO) "    </IMPLEMENTATION>" >> Crypt-X509-CRL.ppd
	$(NOECHO) $(ECHO) ^</SOFTPKG^> >> Crypt-X509-CRL.ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Crypt/X509/CRL.pm blib\lib\Crypt\X509\CRL.pm 
